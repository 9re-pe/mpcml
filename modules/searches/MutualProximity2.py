...
class MutualProximity2(BaseSearch):
    def __init__(
            self,
    ...
    def compute_users_distribution_params(self, distances, n_pairs: int):
    ...
    def predict(self, pairs: torch.Tensor) -> torch.Tensor:
        ...
        users_params = self.compute_users_distribution_params(distances, n_pairs)
